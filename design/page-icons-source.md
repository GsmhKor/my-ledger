...
Input images: Image 2 is the sole edit target and authoritative source. Image 1 is only the UI placement screenshot and must not be included.
Primary request: Preserve the original shark-and-cat illustration exactly, and remove only all English lettering and signature beneath it: remove “THANK YOU!”, “@RMRint”, and every remaining letter/handle mark. Crop away the now-empty lower text area. Remove only the plain white exterior background around the illustration and replace it with genuine transparent alpha.
Subject to preserve exactly: the original large light-blue smiling shark with its dark eye, triangular teeth, fin, tail, gill marks and belly outline; the original tiny white cat below holding the shark overhead with both paws, orange circular side patches, triangular happy mouth, body and legs; all original blue rays and the red sparkle around them.
Composition/framing: keep the original subject positions, proportions, poses, line thickness, slightly blurry low-resolution hand-drawn texture, colors, spacing, and every decorative ray/sparkle. Center the unchanged complete illustration on a compact transparent canvas with minimal padding.
Constraints: do not redraw, beautify, clean up, sharpen, upscale-detail, restyle, recolor, reinterpret, add, remove, resize, or repair any part of the shark, cat, rays, or sparkle. Preserve every original uneven line exactly. Keep white areas inside the shark belly and cat opaque white. No checkerboard, white rectangle, new text, shadow, border, logo, watermark, red annotation circle, or UI. Output only the original illustration without the lower English text and signature.
```
