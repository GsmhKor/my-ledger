...
import catIncomeSalary from '../assets/cat-income-salary.png'
import catIncomeOther from '../assets/cat-income-other.png'
...
const categoryImages = new Map([
  ...
  ['salary', catIncomeSalary],
  ['other-income', catIncomeOther],
])
