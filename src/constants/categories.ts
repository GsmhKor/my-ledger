...
export const EXPENSE_CATEGORIES: Category[] = [
  ...
  { id: 'rent', label: '房租', emoji: '🏠', color: '#ef6c75', type: 'expense' },
  { id: 'utilities', label: '水电煤', emoji: '💡', color: '#f5b942', type: 'expense' },
  { id: 'phone', label: '通讯', emoji: '📱', color: '#26a69a', type: 'expense' },
  { id: 'entertainment', label: '娱乐', emoji: '🎮', color: '#7e8ce0', type: 'expense' },
  { id: 'medical', label: '医疗', emoji: '💊', color: '#ec6f91', type: 'expense' },
  { id: 'daily', label: '日用品', emoji: '🧻', color: '#8d9c75', type: 'expense' },
  { id: 'pet', label: '宠物', emoji: '🐹', color: '#d9955e', type: 'expense' },
  { id: 'travel', label: '旅行', emoji: '✈️', color: '#3bb7ad', type: 'expense' },
