...
export function SettingsPage({ transactions, dark, setDark, onRestore, onClear, notify }: Props) {
  ...
  return <main className="page settings-page">
    ...
    <section className="app-info"><img className="mini-app-icon" src={`${import.meta.env.BASE_URL}pwa-192x192.png`} alt="我的账本图标" /><strong>我的账本</strong><span>版本 {__APP_VERSION__}</span><p>纯本地 · 无账号 · 无追踪</p></section>
  </main>
}
